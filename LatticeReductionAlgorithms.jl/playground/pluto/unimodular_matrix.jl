...
# ╔═╡ 2cd5c707-f820-4c35-8592-305a75932f4c
begin
    using LinearAlgebra: det
    using Symbolics: Num
end

# ╔═╡ 1883bfca-8e04-11f0-29ac-d9b8a45eb402
md"""
# Unimodular matrices: $\mathrm{GL}_n(\mathbb{Z})$
"""

# ╔═╡ 454abccf-cf48-4655-a798-3c4071455d4d
B = [
    4 3 -1
    -2 -3 -6
    0 -3 -1
...
# ╔═╡ e5dc607d-b5e7-4309-84b6-f9309b4bda94
C1 = [
    143 -241 110
    -20 -64 -5
    19 -45 16
...
# ╔═╡ 9d32f9c0-2b05-43ad-8880-576543b2eecd
C2 = [
    -26357 4836 -105971
    13270 -2438 53351
    2307 -424 9275
...
# ╔═╡ 54b7868a-3912-412f-ace4-0847da707ff3
T1 = [
    37 -58 28
    -4 6 -3
    -7 27 -7
...
# ╔═╡ bb26f707-c48a-489d-b7c9-258addd88733
T2 = [
    -5924 1087 -23818
    -828 152 -3329
    177 -32 712
...
# ╔═╡ 07171853-0e4c-4d4c-94c1-22c3ef88caf7
begin
    @assert det(Num.(T1)) ∈ [-1, 1] # T1 ∈ GL₃(ℤ)
    @assert det(Num.(T2)) ∈ [-1, 1] # T2 ∈ GL₃(ℤ)
end

# ╔═╡ c7233114-c8db-45d9-a9d3-0de41663bc43
inv(Num.(T2))

# ╔═╡ 05b85edd-1a63-4e30-904e-700a31c637a1
inv(Num.(T1))

# ╔═╡ 9ea1f570-1c8d-42b9-b262-ed1ad60896b9
begin
    @assert C1 == B * T1
    @assert C2 == B * T2
    #=
    よって C1, C2 は B と同じ格子を生成する．
    =#
end
...
manifest_format = "2.0"
project_hash = "c0c2d7086b591c5738801f59390083ebf49d0bab"
